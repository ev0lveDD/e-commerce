...
function Product({item}) {
    return(
        <div className="w-11/12 md:w-96 flex flex-row md:flex-col items-center justify-start mx-auto mt-8">
          <div>
            <img src={item.image} className="w-96 h-48 md:h-80 object-cover"></img>
          </div>
